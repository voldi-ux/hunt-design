...
export const ContentDetails = [
  {
    title: "Web Disign",
    content: `Web design refers to how the website is displayed on the internet and on a user's device. Ensuring that your website is displayed beautifully is my number one priority. The website will be scalable and the codes will be extensible in order to ensure that there is sufficient room for your business to grow and expand`,
  },
  {
    title: "UI/UX",
...
export const websites = [
  ...
  },
  {
    ...
    image: trilo,
    color: "#ED1E79",
    description: `Trilo site is an html 5 website template. It has an awesome look and feel and provides an awesome user interface and user experience.`,
    link: " https://voldi-ux.github.io/trillo-web/",
  },
  {
